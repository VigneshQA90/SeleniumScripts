...
public class ObservationDownloadFlow {

	public WebDriver driver;
	public WebDriverWait wait;

	public ObservationDownloadFlow(WebDriver driver) {
		this.driver = driver;
		wait = new WebDriverWait(driver, 25);
	}

	public void DownloadWANFIleAndVerifyDownloadedFileInDownloadFolder() throws InterruptedException {
		WebElement dashObs = wait.until(org.openqa.selenium.support.ui.ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//div[@class='x-treelist-toolstrip']/div[contains(@class,'observation-icon')]")));
		...
		WebElement OBSList = wait.until(org.openqa.selenium.support.ui.ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//div[text()='Observation List']")));
		OBSList.click();

		WebElement FirstOBSID = wait.until(org.openqa.selenium.support.ui.ExpectedConditions.visibilityOfElementLocated(
				By.xpath("(//div[@class='x-grid-item-container'])[last()]//table[1]//td[2]")));
		FirstOBSID.click();
