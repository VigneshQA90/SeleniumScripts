...
public class WANPDFReaderWithImgComp {

    public static WebDriver driver;
    public WebDriverWait wait;

    public WANPDFReaderWithImgComp(WebDriver driver) {
    ...
    private static void verifyTextAndImagesInPDF(PDDocument document, File pdfFile) throws Exception {
    	   //     PDDocument document = null;
            ...
            public static int getPDFImagesCount(PDDocument document) throws IOException, InterruptedException {
            	Thread.sleep(2000);
            ...
            public static List<RenderedImage> getImagesFromPDF(PDDocument document) throws IOException, InterruptedException {
            	Thread.sleep(2000);
            ...
            public static void imageCompare(File fileA, File fileB) throws InterruptedException {
